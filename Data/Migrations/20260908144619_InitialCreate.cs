        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NomeCompleto = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Autorizzato = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clienti_AspNetUsers_UtenteId",
                        column: x => x.UtenteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attivita_Progetti_ProgettoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProgettoId = table.Column<int>(type: "int", nullable: false),
                    AttivitaId = table.Column<int>(type: "int", nullable: true),
                    Ore = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    Note = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistrazioniOre", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RegistrazioniOre_AspNetUsers_UtenteId",
                        column: x => x.UtenteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RegistrazioniOre_Attivita_AttivitaId",
                        column: x => x.AttivitaId,
                        principalTable: "Attivita",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RegistrazioniOre_Progetti_ProgettoId",
                        column: x => x.ProgettoId,
                        principalTable: "Progetti",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistrazioniOre_AttivitaId",
                table: "RegistrazioniOre",
                column: "AttivitaId");

            migrationBuilder.CreateIndex(
                name: "IX_RegistrazioniOre_ProgettoId",
                table: "RegistrazioniOre",
                column: "ProgettoId");

            migrationBuilder.CreateIndex(
                name: "IX_RegistrazioniOre_UtenteId",
                table: "RegistrazioniOre",
                column: "UtenteId");
        }
